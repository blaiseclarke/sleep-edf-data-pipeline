...
### Results
The pipeline successfully processed the entire PhysioNet Sleep-EDF (Age Study), ingesting and analyzing over **212,000** 30-second epochs across all 78 valid subjects.
